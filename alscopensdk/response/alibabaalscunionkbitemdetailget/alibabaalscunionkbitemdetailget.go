...
type Response struct {
	...
	ResultResponse ResultResponse `json:"alibaba_alsc_union_kb_item_detail_get_response"`
}
...
type Data struct {
	...
	ShopItemImages        ShopItemImages `json:"shop_item_images"`
...
type ShopItemImages struct {
	Integer []ImageDto `json:"integer"`
}
