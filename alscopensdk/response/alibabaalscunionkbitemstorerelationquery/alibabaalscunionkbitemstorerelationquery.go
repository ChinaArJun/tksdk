...
type Response struct {
	...
	ResultResponse ResultResponse `json:"alibaba_alsc_union_kb_item_store_relation_query_response"`
}
...
type Records struct {
	KBItemShopRelationDto []KBItemShopRelationDto `json:"kb_item_shop_relation_dto"`
}

type KBItemShopRelationDto struct {
